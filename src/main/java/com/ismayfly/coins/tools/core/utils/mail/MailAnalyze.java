...
import com.ismayfly.coins.tools.core.constant.MailBillTypeConstants;
...
public class MailAnalyze {
	...
	public String downLoadLinux(StringBuffer content,
			...
			String second_save ,String path_dir) throws MayflyException {
	...
	public String getFrom(MimeMessage msg) throws MayflyException {
		String from = "";
		Address[] froms;
		try {
			froms = msg.getFrom();
			...
			log.info("getFrom method",e1);
			throw new MayflyException();
		} catch (UnsupportedEncodingException e) {
			log.info("getFrom method",e);
			throw new MayflyException();
		}
	...
	public String getReceiveAddress(MimeMessage msg,
			Message.RecipientType type) throws MayflyException  {
		...
		try {
			...
			log.info("getReceiveAddress method",e);
			throw new MayflyException();
		}
	...
	public String getSentDate(MimeMessage msg, String pattern) throws MayflyException{
		try {
			Date receivedDate;
	...
	public void getMailTextContent(Part part, StringBuffer content) throws MayflyException{
		...
		try {
			...
			log.info("getMailTextContent method",e);
			throw new MayflyException();
		} catch (IOException e) {
			log.info("getMailTextContent method",e);
			throw new MayflyException();			}
